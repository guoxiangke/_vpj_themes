						   	 	...
						   	 	<?php if($user->uid){print $links ;}
					 								...
					 								<ul class="links inline">
														<li class="flag-bookmarks"><span><span class="flag-wrapper flag-bookmarks flag-bookmarks-365">
														      <a rel="nofollow" class="flag flag-action flag-link-toggle flag-processed" title="喜欢" href="javascript:void(0);" onclick="javascript:alert('对不起，该操作需要您登录！');"><img src='<?php echo path_to_theme('vpj') ?>/images/xin.gif' />(0)</a><span class="flag-throbber">&nbsp;</span>
														    </span>
														</span></li>
