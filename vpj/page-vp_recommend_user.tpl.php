			...
			$jq(document).ready(function(){
				...
				*/
				$('.dpdybtn').click(function(){
					$(this).parent().parent().next().find('.vp-rec-wrap:visible').find('.fasttoggle-status-user-follow-0').click();
					//console.log($(this).parent().parent().next().find('.vp-rec-wrap:visible').find('.fasttoggle-status-user-follow-0'));
				})
			});
		</script>	
				    ...
				    <div class="dpright-content-top">
						...
						<div class="tab-content">
						  ...
						  <?php	//6X3 被关注最多 订阅最多的买家
					  			...
					  			echo sina_vp_recommend($results,$account,$type='follow');
							?>
						  </div>
