...
<base id="headbase" href="http://bbs.weiphone.com/" />

<style type="text/css">

body{ font-size:12px;padding:0;margin:0;}

a{ text-decoration:none;color:#313c47;}
...
.tip-bgA,.tip-bgB,.tip-bgC,.tip-bgC {background:#313c47;}
...
.btn{border-color:#313c47;margin-right:1em;color:#fff;background:#313c47;}
...
<span class="f14">对不起,本版块为认证版块,您没有权限查看此版块的内容!<a href="http://dev.weipujie.com?q=login">点此登录</a></span><br /><div class="cc" style="padding:10px 20px 20px 0;">
...
</div><a href="http://dev.weipujie.com" tabindex="20" id="showindex" class="fr">返回首页</a></div>
