...
<div class="vp_content">
	...
	<?php endif; ?>
	<div class='VCenter-top'><p id='VCenter_title' class='VCenter-nav'>爆款</p></div>
  ...
  <div class="tm_sale">
    ...
    <div class="sale_tm sale_tm_list">
      ...
      <?php if( in_array('Seller', $user->roles) ) : ?>
    	<span class="fb_btn">
    		<?php echo l('发布爆款','new/4',array('attributes'=>array('class'=>'Seller-new-item')));?>
    	</span>
    	<?php endif; ?>	
			</div>
	  	  ...
	  	  $results = db_query($sql,$account->uid);
		      ...
		      $sale_nids [] = $row['nid'];
				...
				//wsm
				$sale_nids=array_unique($sale_nids);
	  	?>
							...
							<div class="wb_bk01 bor_top">
								...
								<div class="fbbk_nr">
							      ...
							      <?php 
								      ...
								      echo ' · '; 
											echo l("分享($share_counts)","forward/3/$sale_node->nid"); 
							      ?>
							      </span>  
				          	<?php
